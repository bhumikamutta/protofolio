...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_k4hqyve', 'template_x413uha', form.current, 'xNVff-vWygfkNfxrY')
      .then((result) => {
  ...
  return (
    <div className="container mt-5">
      ...
      <form ref={form} onSubmit={sendEmail} className="shadow p-4 rounded bg-light">
        ...
        {done && <div className="text-success text-center mt-3">Message Sent Successfully ✅</div>}
      </form>
    </div>
  );
};
